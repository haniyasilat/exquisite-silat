const OUTFITS = [
  {
    ...
    collage_image: "assets/products/teal-elevate-look/collage.png?v=3",
    pieces: [
      ...
      { slot: "Belt", label: "Brown Braided Leather Belt", amazon_url: "https://amzn.to/4hOJaCC" },
      { slot: "Earrings", label: "Chunky Gold Knot Earrings", amazon_url: "https://link.amazon/B0b8nLrrj" },
      { slot: "Bangle", label: "Gold Chunky Bangle", amazon_url: "https://amzn.to/4fAwRbW" },
      { slot: "Bangle", label: "Gold Ridged Bangle", amazon_url: "https://amzn.to/4hOJaCC" },
